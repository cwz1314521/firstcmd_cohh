...
public class OrdersModel {
    ...
    private List<OrderIngredientsModel> orderIngredients;
    ...
    public List<OrderIngredientsModel> getOrderIngredients() {
        return orderIngredients;
    }

    public void setOrderIngredients(List<OrderIngredientsModel> orderIngredients) {
