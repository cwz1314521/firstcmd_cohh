...
/**
 * @Department 新零售
 * @ClassName DiscountsEditCondition
 * @Description edit
 * @Author ---CWZ
 * @Date 2019/1/3 18:42
 * @Version 1.0
...
@ApiModel(value = "DiscountsEditCondition",description = "DiscountsEditCondition")
@Data
public class DiscountsEditCondition {
    ...
    @DecimalMax(value = "1000000",message = "发行数量输入范围有误 1-1000000")
    @DecimalMin(value = "1",message = "发行数量输入范围有误 1-1000000")
