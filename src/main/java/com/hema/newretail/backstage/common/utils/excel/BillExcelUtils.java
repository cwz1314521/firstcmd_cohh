...
import com.hema.newretail.backstage.common.utils.CommonConstants;
...
/**       InputStream in = BillExcelUtils.class.getResourceAsStream("/BOOT-INF/classes/excelModel/"+orderSrcFileName);*/
    ...
    //根据指定的excel模板导出数据
    public static void exportOrderExcel(String orderSrcFileName, List<OrderBo> data, OutputStream fos, String time) throws Exception {
        ...
        for (int i=0;i<data.size();i++){
            ...
            newRow.getCell(0).setCellValue(i+1);
            newRow.getCell(1).setCellValue(order.getOrderId());
            newRow.getCell(2).setCellValue(order.getOrderTime());
            newRow.getCell(3).setCellValue(order.getMenuName());
            newRow.getCell(4).setCellValue(order.getSugar()+"  "+order.getTemperature());
            newRow.getCell(5).setCellValue(order.getStatus());
            newRow.getCell(6).setCellValue(order.getErrorCode());
            newRow.getCell(7).setCellValue(order.getCupType());
            newRow.getCell(8).setCellValue(order.getCoupon());
            newRow.getCell(9).setCellValue(order.getCouponCode());
            newRow.getCell(10).setCellValue(order.getDiscounts());
            newRow.getCell(11).setCellValue(order.getBillId());
            newRow.getCell(12).setCellValue(order.getMachineName());
            newRow.getCell(13).setCellValue(order.getMachineLocation());
            newRow.getCell(14).setCellValue(order.getCompanyName());
            newRow.getCell(15).setCellValue(order.getGridCompany());
            newRow.getCell(16).setCellValue(order.getAgentName());
        }
