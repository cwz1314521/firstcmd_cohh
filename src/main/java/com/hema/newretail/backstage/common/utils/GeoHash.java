...
public class GeoHash {
    ...
    public static void main(String[] args) {
        ...
        GeoHash g = new GeoHash(36.67364100000000, 117.29383900000000);
        System.out.println("1>>>>>>"+g.getGeoHashBase32());

        /*LocationBean locationBean = g.getLocation(g.getGeoHashBase32());
        System.out.println("locationBean"+locationBean.getLat()+">>"+locationBean.getLng());*/
        /*GeoHash ge = new GeoHash(39.8450247791, 116.4442935642);
        System.out.println("2>>>"+ge.getGeoHashBase32());
        GeoHash ge1= new GeoHash(39.7450247791, 116.4442935642);
        System.out.println("3>>>"+ge1.getGeoHashBase32());;
        GeoHash ge2= new GeoHash(39.7450247792, 116.4442935641);
        System.out.println("3>>>"+ge2.getGeoHashBase32());;*/
