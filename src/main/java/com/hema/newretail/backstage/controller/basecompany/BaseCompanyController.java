...
public class BaseCompanyController extends BaseController {
    ...
    public Response findAll(@RequestBody BaseCompanyQueryParameter params) {
        ...
        params.setOrgCode(baseUserInfoEntry.getOrgCode());
        return baseCompanyService.findAll(params);
    }

    @ApiOperation("保存分公司网格信息")
    ...
    @ApiOperation("地图模式-根据地市或关键字查询分公司名称")
    ...
    @ApiOperation("地图模式-根据地图地址查询分公司网格")
